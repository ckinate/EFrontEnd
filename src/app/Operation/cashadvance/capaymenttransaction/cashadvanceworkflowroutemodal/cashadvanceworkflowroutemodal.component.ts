...
@Component({
  selector: 'cashadvanceWorkflowRouteModal',
  templateUrl: './cashadvanceworkflowroutemodal.component.html',
  styleUrls: ['./cashadvanceworkflowroutemodal.component.css'],
  encapsulation: ViewEncapsulation.None,
  animations: [appModuleAnimation()]

})
export class CashAdvanceworkflowroutemodalComponent extends AppComponentBase implements OnInit {

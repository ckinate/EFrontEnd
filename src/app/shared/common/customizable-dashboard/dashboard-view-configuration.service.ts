...
import { WidgetExpenseStatsComponent } from './widgets/widget-expense-stats/widget-expense-stats.component';
import { WidgetBudgetStatsComponent } from './widgets/widget-budget-stats/widget-budget-stats.component';
import { WidgetWorkflowStatsComponent } from './widgets/widget-workflow-stats/widget-workflow-stats.component';
...
export class DashboardViewConfigurationService {
  ...
  private initializeConfiguration() {
    ...
    let expenseTopStats = new WidgetViewDefinition(
      DashboardCustomizationConst.widgets.tenant.expenseTopStats,
      WidgetExpenseStatsComponent,
    );
   let budgetStats = new WidgetViewDefinition(
      DashboardCustomizationConst.widgets.tenant.budgetStats,
      WidgetBudgetStatsComponent,
    );
    let workflowStats = new WidgetViewDefinition(
      DashboardCustomizationConst.widgets.tenant.workflowStats,
      WidgetWorkflowStatsComponent,
    );
   ...
   //add your host side widgets here
    ...
    this.WidgetViewDefinitions.push(expenseTopStats);
    this.WidgetViewDefinitions.push(budgetStats);
    this.WidgetViewDefinitions.push(workflowStats);
  }
}

...
import {
  ...
  AddNewPageOutput, AddWidgetInput, RenamePageInput, SavePageInput, Page, Widget, WidgetFilterOutput, WidgetOutput, OperatingExpenseServiceServiceProxy, WorkflowServiceServiceProxy, WorkflowQueryDto
...
export class CustomizableDashboardComponent extends AppComponentBase implements OnInit, OnDestroy {
  ...
  loadqueryTrail() {
    this._opex.getloginopexQuery().subscribe(result => {

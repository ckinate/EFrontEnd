        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'posting-logs', component: PostingLogsComponent, data: { permission: 'Pages.Administration.AuditLogs' } },
                    ...
                    { path: 'tenantSettings', component: TenantSettingsComponent, data: { permission: 'Pages.Administration.Users' }},
                    ...
                    { path: 'dynamic-entity-property-value/manage-all/:entityFullName/:rowId', component: DynamicEntityPropertyValueComponent, data: { permission: 'Pages.Administration.DynamicEntityProperties' } },
                     ...
                     { path: 'companystructure', component: OrganizationalstructureComponent , data: { permission: 'Pages.Administration.CompanyStructure' } },

...
export class AppPreBootstrap {
    ...
    private static getApplicationConfig(
        ...
        XmlHttpRequestHelper.ajax(type, url, customHeaders, null, (result) => {
            ...
            AppConsts.reportUrl = result.reportUrl;
            AppConsts.cashADUrl = result.cashADUrl;
            AppConsts.OpexReqreportUrl = result.OpexReqreportUrl;
            AppConsts.CallOverUrl = result.CallOverUrl;
            AppConsts.AccrualReport = result.AccrualReport;
            AppConsts.AmortReport = result.AmortReport;
            ...
            if (tenancyName == null) {
                ...
                AppConsts.ClientId = result.ClientId.replace(
                    AppConsts.tenancyNamePlaceHolderInUrl + '.',
                    ''
                );
